...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("/Users/sosoki/gmall-parent/gmall-mbg" + "/src/main/java");
        gc.setAuthor("Lfy");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3307/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
